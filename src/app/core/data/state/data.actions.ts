...
export const dataGetRequest = createAction(DATA_GET_REQUEST, props<{ payload: any }>());
...
export const customDataGetRequest = createAction(CUSTOM_DATA_GET_REQUEST, props<{ payload: any }>());
